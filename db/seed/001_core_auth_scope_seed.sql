-- Core auth/scope seed draft
-- Purpose: provide minimal rows for validating Supabase session and users
-- repository behavior. Auth accounts are linked later through users.auth_user_id.
